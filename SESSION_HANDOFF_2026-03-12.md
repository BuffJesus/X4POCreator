...
2. Target these remaining high-value methods next:
   - `_bulk_apply_editor_value`
   - `_bulk_fill_selected_cells`
   - `_bulk_clear_selected_cells`
   - `_bulk_remove_selected_rows`
3. After another bulk-edit extraction, add workflow-style tests that cover:
...
3. Continue with `_bulk_apply_editor_value` extraction first
