...
class BulkDialogTests(unittest.TestCase):
    ...
    def test_bulk_remove_not_needed_flushes_pending_edit_before_reading_visible_rows(self):
        state = {"rows": ["0"]}
        seen = {}
    ...
    def test_item_details_rows_include_trigger_and_overstock_fields(self):
        ...
        item = {
            ...
            "release_decision_detail": "hold_for_threshold",
            "release_decision_detail_label": "Hold for threshold",
        ...
        self.assertEqual(row_lookup["Release Detail"], "Hold for threshold")
    ...
    def test_item_details_rows_show_receipt_vendor_evidence(self):
        ...
        self.assertEqual(row_lookup["Pack Source"], "Receipt History")
